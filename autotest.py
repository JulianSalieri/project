...
user_number.send_keys(setting.MY_NUMBER)  # указываем наш номер телефона

next_registration = driver.find_element_by_class_name(
    "CwaK9")  # смс код надо ввести руками, после чего тест продолжится
next_registration.click()
time.sleep(40)
